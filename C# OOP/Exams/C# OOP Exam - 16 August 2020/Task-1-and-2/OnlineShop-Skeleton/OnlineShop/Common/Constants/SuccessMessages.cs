namespace OnlineShop.Common.Constants
{
    public static class SuccessMessages
    {
        ...
        public const string ComputerComponentsToString = " Components ({0}):"; // one space at the beginning
        
        public const string ComputerPeripheralsToString = " Peripherals ({0}); Average Overall Performance ({1}):"; // one space at the beginning
    }
}